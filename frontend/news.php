...
<section id="news" class="py-20 px-6">
  <div class="max-w-6xl mx-auto">
    <h2 class="text-4xl md:text-5xl font-bold text-center mb-4" data-aos="fade-up">news</h2>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      <!-- News Item 1 -->
      <div class="bg-slate-800/40 border border-slate-700 rounded-xl overflow-hidden hover:border-concern-accent transition-all" data-aos="fade-up" data-aos-delay="100">
        <div class="h-48 bg-gradient-to-br from-indigo-900 to-cyan-900 flex items-center justify-center">
      ...
      <!-- News Item 2 -->
      <div class="bg-slate-800/40 border border-slate-700 rounded-xl overflow-hidden hover:border-concern-accent transition-all" data-aos="fade-up" data-aos-delay="200">
        <div class="h-48 bg-gradient-to-br from-indigo-900 to-cyan-900 flex items-center justify-center">
          <span class="text-6xl">🚀</span>
        </div>
        <div class="p-6">
      ...
      <!-- News Item 3 -->
      <div class="bg-slate-800/40 border border-slate-700 rounded-xl overflow-hidden hover:border-concern-accent transition-all" data-aos="fade-up" data-aos-delay="300">
        <div class="h-48 bg-gradient-to-br from-indigo-900 to-cyan-900 flex items-center justify-center">
          <span class="text-6xl">🔧</span>
        </div>
        <div class="p-6">
